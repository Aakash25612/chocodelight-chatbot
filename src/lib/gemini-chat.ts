...
- Pending Sauda / pending locked order / unshipped quantity (quantity − quantityShipped) -> get_pending_sauda. Present summary totals, then top items/customers, and detail lines with item name, pending qty, and amount.
